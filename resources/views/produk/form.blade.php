...
<main style="margin-top: 70px">
    <div class="container">
        @if (count($errors) > 0)
        <div class="alert alert-danger"> <b>Perhatian</b>
            <ul>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-5">
                            <select name="kategori_produk" id="kategori_produk" class="form-control">
                                <option @selected(old('kategori_produk', @$produk->kategori_produk) == '')
                                    value="">- Pilih Kategori Produk -</option>
                                <option @selected(old('kategori_produk', @$produk->kategori_produk) == 'Sepatu')
                                    value="Sepatu">Sepatu</option>
                                <option @selected(old('kategori_produk', @$produk->kategori_produk) == 'Baju')
                                    value="Baju">Baju</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-5">
                            <input type="text" class="form-control" name="nama_produk" id="nama_produk"
                                placeholder="Nama Produk" value="{{ old('nama_produk', @$produk->nama_produk) }}">
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-5">
                            @if (!empty($produk->foto_produk))
                                <img src="{{ @$produk->foto_produk }}" alt="Foto" width="100px" class="mb-3">
                            @endif
